...
export default function Hero() {
  return (
    <div className="flex flex-col items-center  gap-6 py-20 px-4 text-center w-full text-gray-700 dark:text-white">
      ...
      <h1 className="font-bold text-5xl">Turning imagination into<p><span className="bg-gradient-to-r from-[#5044e5] to-[#4d8cea] bg-clip-text text-transparent" >digital </span>impact</p></h1>
